...
void test_bcast(const int VLEN, gaspi_segment_id_t const segment_id){
  ...
  gaspi_bcast(segment_id, 0, VLEN, GASPI_TYPE_DOUBLE, root, queue_id, GASPI_BLOCK);
...
void test_evnt_consist_bcast(const int VLEN, gaspi_segment_id_t const segment_id, const double threshold){
  ...
  gaspi_bcast(segment_id, 0, VLEN, GASPI_TYPE_DOUBLE, threshold, root, queue_id, GASPI_BLOCK);
...
//  test_evnt_consist_bcast_simple(VLEN, segment_id, threshold); 
//  test_bcast_simple(VLEN, segment_id); 
